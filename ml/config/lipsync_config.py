...
DELAY_ESTIMATOR_ADJUSTMENT_SPEED = 0.03                         # must be between 0 and 1, with a higher value the video input queue size changes faster.
...
DELAY_ESTIMATOR_STATIC_DELAY = 0.5                              # this ammount is always added to the delay, to help the vide match the start of the audio